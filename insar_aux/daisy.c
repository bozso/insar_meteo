...
FUNCTION_KEYWORDS(zero_select, daisy_)
...
//static PyObject * test(PyObject * self, PyObject * args)
{
    ...
    println("%ld %ld", NPY_DIM(array, 0), NPY_DIM(array, 1));
...
static PyMethodDef DaisyMethods[] = {
     METHOD_VARARGS(test, daisy_),
     METHOD_KEYWORDS(data_select, daisy_),
     METHOD_KEYWORDS(dominant,    daisy_),
     METHOD_KEYWORDS(poly_orbit,  daisy_),
     METHOD_KEYWORDS(integrate,   daisy_),
     METHOD_KEYWORDS(zero_select, daisy_),
    {NULL, NULL, 0, NULL}
};
