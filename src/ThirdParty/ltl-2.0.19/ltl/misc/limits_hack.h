 ...
 *
 * ---------------------------------------------------------------------
 * $Id: limits_hack.h 491 2011-09-02 19:36:39Z drory $
 * ---------------------------------------------------------------------
 *
 ...
 * ---------------------------------------------------------------------
 *
 * Severely hacked-up version of SGI/libstdc++ limits, for use with LTL.
 */

#ifndef __LTL_LIMITS_HACK__
#define __LTL_LIMITS_HACK__
...
class _Numeric_limits_base
{
   public:
      ...
      static __number epsilon()
      {
         return __number();
      }
      static __number round_error()
      {
         return __number();
      }
