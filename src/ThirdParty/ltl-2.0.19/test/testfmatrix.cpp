...
*
* ---------------------------------------------------------------------
* $Id: testfmatrix.cpp 562 2015-04-30 16:01:16Z drory $
* ---------------------------------------------------------------------
*
...
{
   cerr << "Testing FMatrix (template unrolled loops) ..." << endl;
   cerr << "Size of FMatrix<float,3,3> : " << sizeof( FMatrix<float,3,3> ) << ", float[9] : " << sizeof( float[9] ) << endl;
