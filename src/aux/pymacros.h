...
#define pymeth_noargs(fun_name, doc) \
{#fun_name, (PyCFunction) fun_name, METH_NOARGS, (doc)}

#define pymeth_varargs(fun_name, doc) \
{#fun_name, (PyCFunction) fun_name, METH_VARARGS, (doc)}

#define pymeth_keywords(fun_name, doc) \
